...
describe Track do
  ...
  context "from a = (0, 0) to b = (0, 4.470) to c = (4.470, 4.470)" do

    before(:each) do
      setup_chingu
      @track1 = Track.new(:a_x => 0, :a_y => 0, :b_x => 0, :b_y => 4.470)
      @track2 = @track1.t_b.extend_to(4.470, 4.470)
      @trolley = Fabricate(:trolley)
    end
    ...
    context "when a trolley is added to terminal a of the first track" do
      ...
      context "when it moves forward" do
        ...
        context "after two steps (two seconds)" do
          ...
          it "tells the trolley it is at (4.470, 4.470)" do
            @trolley.x.should be_within(0.001).of(4.470)
            @trolley.y.should be_within(0.001).of(4.470)
          end
        end
...
describe Track do
  ...
  context "from a = (0, 0) to b = (0, 4.000) to c = (5.000, 4.000)" do

    before(:each) do
      setup_chingu
      @track1 = Track.new(:a_x => 0, :a_y => 0, :b_x => 0, :b_y => 4.000)
      @track2 = @track1.t_b.extend_to(5.000, 4.000)
      @trolley = Fabricate(:trolley)
    end
    ...
    context "when a trolley is added to terminal a of the first track" do
      ...
      context "when it moves forward" do
        ...
        context "after one step (one second)" do
          ...
          it "tells the trolley it is at (0.470, 4.000)" do
            @trolley.x.should be_within(0.001).of(0.470)
            @trolley.y.should be_within(0.001).of(4.000)
          end
        end
        ...
        context "after two steps (two seconds)" do
          ...
          it "tells the trolley it is at (4.940, 4.000)" do
            @trolley.x.should be_within(0.001).of(4.940)
            @trolley.y.should be_within(0.001).of(4.000)
          end
        end
    ...
    context "when a trolley is added to terminal b of the second track" do
      ...
      it "tells the trolley it is at (5.000, 4.000)" do
        @trolley.x.should be_within(0.001).of(5.000)
        @trolley.y.should be_within(0.001).of(4.000)
      end
      ...
      context "when it moves forward" do
        ...
        context "after one step (one second)" do
          ...
          it "tells the trolley it is at (0.530, 4.000)" do
            @trolley.x.should be_within(0.001).of(0.530)
            @trolley.y.should be_within(0.001).of(4.000)
          end
        end
        ...
        context "after two steps (two seconds)" do
          ...
          it "tells the trolley it is at (0.000, 0.060)" do
            @trolley.x.should be_within(0.001).of(0.000)
            @trolley.y.should be_within(0.001).of(0.060)
          end
        end
